import EventbriteScraper from './src/scrapers/eventbrite.js';
import Database from './src/database.js';
import { belgianCities } from './src/config/belgian-cities.js';

async function testEventbrite() {
  console.log('Testing Eventbrite scraper - First page only (saving to DB)...\n');
  ...
  try {
    ...
    console.log(`\nFound ${events.length} events from Eventbrite:`);
    ...
    console.error('Error testing Eventbrite scraper:', error);
  } finally {
    await db.close();
  }
}
